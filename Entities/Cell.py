...
class Cell:
    ...
    passive_energy_cost = 0.5
    woohoo_energy_cost = 25
    eat_energy_gain = 20
    eat_grow_size = 2
    ...
    def spend_energy(self):
        self.energy -= self.passive_energy_cost
    ...
    def canWoohoo(self):
        if self.last_woohood >= self.woohoo_cooldown:
            return True
        else:
            return False

    def woohood(self):
        self.energy -= self.woohoo_energy_cost
        self.last_woohood = 0
